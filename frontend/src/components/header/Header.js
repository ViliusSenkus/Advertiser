...
function Header() {
    ...
    const handleSearch = (e) => {
        ...
        axios.get('http://localhost:8000/api/adv/s/' + search)
                ...
                <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    {!user ?
                        <ul className="nav mb-2 justify-content-center mb-md-0">
                            <li><Link to="/login" className="nav-link px-2 link-dar">Login</Link></li>
                            <li><Link to="/register" className="nav-link px-2 link-dar">Register</Link></li>
                        </ul>
                    :

                    // headerio meniu prisijungus
